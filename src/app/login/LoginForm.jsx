            ...
            >
                ...
                <div className="bg-white dark:bg-gray-900 rounded-3xl shadow-xl shadow-sky-100 dark:shadow-sky-900/10 border border-gray-100 dark:border-gray-800 p-8">
                    ...
                    <div className="text-center mb-8">
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">Sign in to your MediCare Connect account</p>
                    </div>
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-4 py-3 rounded-xl text-sm border ${errors.email ? "border-red-400 bg-red-50 dark:bg-red-900/10" : "border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800"} text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-sky-400 dark:focus:ring-sky-500 transition`}
                                    {...register("email", {
                        ...
                        <div>
                            ...
                            <div className="relative">
                                ...
                                <input
                                    ...
                                    className={`w-full pl-10 pr-10 py-3 rounded-xl text-sm border ${errors.password ? "border-red-400 bg-red-50 dark:bg-red-900/10" : "border-gray-200 dark:border-gray-700 bg-gray-50 dark:bg-gray-800"} text-gray-900 dark:text-white focus:outline-none focus:ring-2 focus:ring-sky-400 dark:focus:ring-sky-500 transition`}
